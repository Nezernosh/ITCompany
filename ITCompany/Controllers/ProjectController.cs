...
namespace ITCompany.Controllers
{
    public class ProjectController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Create([Bind(Include = "Status, Description, Title, Budget")]Project project)
        {
        ...
        [HttpPost]
        public ActionResult Edit([Bind(Include = "ClientID, Status, Description, Title, Budget")] Project project)
        {
            try
            {
                if (ModelState.IsValid)
